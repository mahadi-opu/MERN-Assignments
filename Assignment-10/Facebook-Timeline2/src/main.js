const postArea = document.querySelector(".user");
...
posts.map((item, index)=> {                     
    ...
    <div class="user-post-header">
      <div class="post-info">
        <img src="${item.author.authorPhoto}" alt="" />
    ...
    <div class="post-comments">
      <div class="comments-header">
        <div class="reaction">
          ...
          <a href="#">Kajal Datta, Sufia Sepu and ${item.like} others</a>
        </div>
        <div class="counts">
          <a href="#">${item.comment} Comments</a>
        </div>
      </div>
